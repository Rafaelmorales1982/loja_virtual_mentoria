...
//Essa classe esta ligada a Loja ou seja utilizada para comprar dos fornecedores para dar entrada na loja (Controle da loja)
@Entity
...
public class NotaFiscalCompra implements Serializable{
	...
	//Associação muitos para um -> entre Nota Fiscal Compra e Pessoa olhar diagrama de classe
